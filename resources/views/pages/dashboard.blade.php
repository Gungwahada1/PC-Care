                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-6 text-center">{{ $countPelanggan }}</div>
                                    <div class="text-base text-slate-500 mt-1 text-center">Pelanggan</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-6 text-center">{{ $countPegawai }}</div>
                                    <div class="text-base text-slate-500 mt-1 text-center">Pegawai</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-6 text-center">{{ $countProduk }}</div>
                                    <div class="text-base text-slate-500 mt-1 text-center">Jumlah Produk</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-6 text-center">{{ $kategoriProduk }}</div>
                                    <div class="text-base text-slate-500 mt-1 text-center">Kategori Produk</div>
                                </div>
                            </div>
                        </div>
                    </div>
