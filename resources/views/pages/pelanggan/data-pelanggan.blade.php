...
@section('subhead')
    <title>Data Pelanggan - PC Care</title>
@endsection
...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            {{-- <a class="btn btn-primary shadow-md mr-2" href="{{ route('tambah.pelanggan') }}">Tambah Pelanggan</a> --}}
            <div class="dropdown">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3"
                                        href="{{ url('/edit-pelanggan/' . $item->id . '/edit') }}">
                                        <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                    </a>
                                    <form action="{{ url('/delete-pelanggan/' . $item->id) }}" method="POST">
                                        @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <div class="px-5 pb-8 text-center flex justify-center gap-2">
