...
@section('subhead')
    <title>Edit Pegawai - PC Care</title>
@endsection
        ...
        <div id="input" class="p-5">
            <form action="{{ url('update-pegawai/' . $pegawai->id) }}" method="POST">
                ...
                <div class="pt-5">
                    ...
                    <input id="status" type="number" name="active" class="form-control" value="{{ $pegawai->active }}">
                    <p class="text-gray mt-1 ml-1">0 => Selesai Bekerja; 1 => Masih Bekerja</p>
                </div>
                <div class="pt-5">
                    <label for="role" class="form-label">Role</label>
                    <input id="role" type="number" name="role" class="form-control" value="{{ $pegawai->role }}">
