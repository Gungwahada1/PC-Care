...
@section('subcontent')
    @foreach ($landingPage as $item)
        <form action="{{ url('update-landing-page/' . $item->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 lg:col-span-6">
                    ...
                    <div class="intro-y box p-5">
                        <div>
                            <label for="title1" class="form-label">Title Slider 1</label>
                            <input id="title1" name="title1" type="text" class="form-control w-full mb-5"
                                placeholder="Title 1" value="{{ $item->title1 }}">
                        </div>
                        <div>
                            <label for="description1" class="form-label">Deskripsi Slider 1</label>
                            <textarea name="description1" id="description1" cols="30" rows="10" class="form-control w-full mb-5">{{ $item->description1 }}</textarea>
                        </div>
                        <div>
                    ...
                    <div class="intro-y box p-5">
                        ...
                        <div class="intro-y box">
                            <div
                                ...
                                <h2 class="font-medium text-base mr-auto">Gambar Banner 1</h2>
                            </div>
                            <div id="single-file-upload" class="p-5">
                                <div class="preview">
                                    <div data-single="true" class="dropzone">
                                        <div class="fallback">
                                            <input name="imageBanner1" type="file" value="{{ $item->imageBanner1 }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
