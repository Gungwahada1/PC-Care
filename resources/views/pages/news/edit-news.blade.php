...
@section('subcontent')
    <div class="intro-y box">
        ...
        <div id="input" class="p-5">
            <form action="{{ url('update-berita/' . $berita->id) }}" method="POST">
                @csrf
                ...
                <div class="">
                    ...
                    <input id="name" type="text" class="form-control" name="title"
                        placeholder="Input Judul Berita" value="{{ $berita->title }}">
                </div>
                <div class="py-5" id="classic-editor">
                    <div class="preview">
                        <label for="name" class="form-label">Konten</label>
                        <textarea name="content" id="content" cols="30" rows="10" class="editor">{{ $berita->content }}</textarea>
                    </div>
                </div>
