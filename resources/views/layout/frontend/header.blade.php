                    ...
                    <div class="topbar-text d-none d-md-block d-lg-block">
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <a href="tell:+6281246244399"><span class="fas fa-phone mr-2"></span> 24x7 Technical
                                    Support +6281 246 244 399</a>
                            </li>
                    ...
                    <div class="topbar-text">
                        @if (Route::has('login.index'))
                            <ul class="list-inline text-right">
                                @auth
                                    <li class="list-inline-item"><a href="{{ route('logout') }}"><span
                                                class="fas fa-user mr-2"></span>
                                            Logout</a>
                                    </li>
                                @else
                                    <li class="list-inline-item"><a href="{{ route('login.index') }}"><span
                                                class="fas fa-user mr-2"></span>
                                            Login</a>
                                    </li>
                                    <li class="list-inline-item"><a href="{{ route('register.index') }}"><span
                                                class="fas fa-lock mr-2"></span>
                                            Register</a>
                                    </li>
                                @endauth
                            </ul>
        ...
        <div class="container">
            <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                ...
                <a class="navbar-brand" href="{{ route('front.index') }}">
                    <img src="assets/img/logo.png" width="50" alt="logo" class="img-fluid" />
                    {{-- <span class="ml-3 text-info text-bold">PC Care</span> --}}
                </a>
                <!--logo end-->
                    ...
                    <ul class="navbar-nav ml-auto main-navbar-nav">
                        ...
                        <li class="nav-item hs-has-mega-menu custom-nav-item" data-position="left">
                            <a id="homeMegaMenu" class="nav-link custom-nav-link main-link-toggle"
                                href="{{ route('front.index') }}" aria-haspopup="true" aria-expanded="false">Home</a>
                                        ...
                                        <div class="row mega-menu-wrap">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                ...
                                                <ul class="sub-menu-nav-group">
                                                    ...
                                                    <li><a class="nav-link sub-menu-nav-link"
                                                            href="index-domain-search.html">Home Domain Search
                                                            <span class="badge badge-danger ml-2">Hot</span></a>
                                                    </li>
                                                    <li><a class="nav-link sub-menu-nav-link"
                                            ...
                                            <div class="col-md-6">
                                                <ul class="sub-menu-nav-group mb-3">
                                                    ...
                                                    <li><a class="nav-link sub-menu-nav-link"
                                                            href="index-content-slider.html">Home Content
                                                            Slider</a></li>
                                                    <li><a class="nav-link sub-menu-nav-link"
                        ...
                        <li class="nav-item hs-has-sub-menu custom-nav-item">
                            <a id="pagesMegaMenu" class="nav-link custom-nav-link main-link-toggle"
                                href="{{ route('front.products') }}" aria-haspopup="true" aria-expanded="false"
                            ...
                            <ul id="pagesSubMenu" class="hs-sub-menu main-sub-menu" aria-labelledby="pagesMegaMenu"
                                ...
                                <li class="nav-item submenu-item">
                                    <a class="nav-link sub-menu-nav-link" href="offer-single-page.html">Black
                                        Friday Single <span class="badge badge-warning ml-auto">New</span></a>
                                </li>
                                ...
                                <li class="hs-has-sub-menu">
                                    ...
                                    <ul id="navSubmenuPagesBlog" class="hs-sub-menu main-sub-menu"
                                        ...
                                        <li><a class="nav-link sub-menu-nav-link" href="blog-grid.html">Blog
                                                Grid</a></li>
                                        <li><a class="nav-link sub-menu-nav-link" href="blog-sidebar.html">Blog
                                                With Sidebar</a></li>
                                ...
                                <li class="hs-has-sub-menu">
                                    ...
                                    <ul id="navSubmenuPagesUtilities" class="hs-sub-menu main-sub-menu"
                                        ...
                                        <li><a class="nav-link sub-menu-nav-link" href="status.html">Status</a>
                                        </li>
                                        <li><a class="nav-link sub-menu-nav-link" href="knowledge-base.html">Knowledge
                                                Base</a></li>
                                ...
                                <li class="hs-has-sub-menu">
                                    ...
                                    <ul id="navSubmenuPagesSpecialty" class="hs-sub-menu main-sub-menu"
                                        ...
                                        <li><a class="nav-link sub-menu-nav-link" href="404.html">Error 404</a>
                                        </li>
                                    </ul>
                                </li>
                                <!-- Specialty -->
                        ...
                        <li class="nav-item hs-has-mega-menu custom-nav-item" data-max-width="720px"
                            ...
                            <a id="hostingMegaMenu" class="nav-link custom-nav-link main-link-toggle"
                                href="{{ route('front.news') }}" aria-haspopup="true" aria-expanded="false">News</a>
                        ...
                        <li class="nav-item hs-has-mega-menu custom-nav-item" data-max-width="600px"
                            ...
                            <a id="elementsMegaMenu" class="nav-link custom-nav-link main-link-toggle"
                                href="{{ route('front.contact') }}" aria-haspopup="true" aria-expanded="false">Contact
                                Us</a>
                        ...
                        <li class="nav-item hs-has-mega-menu custom-nav-item" data-max-width="250px"
                            ...
                            <a id="aboutMegaMenu" class="nav-link custom-nav-link main-link-toggle"
                                href="{{ route('front.about') }}" aria-haspopup="true" aria-expanded="false">About
                                Us</a>
                        ...
                        <li class="nav-item header-nav-last-item d-flex align-items-center">
                            @auth
                                <a class="btn primary-solid-btn animated-btn" href="{{ route('dashboard') }}">
                                    {{-- target="_blank"> --}}
                                    Dashboard
                                </a>
                            @endauth
                            @guest
                                <a class="btn primary-solid-btn animated-btn" href="{{ route('front.letsChat') }}"
                                    target="_blank">
                                    Let's Chat
                                </a>
                            @endguest
