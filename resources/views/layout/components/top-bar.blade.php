...
<div class="top-bar">
    ...
    <!-- END: Notifications -->
    <div class="intro-x mr-10">
        <div class="btn btn-primary py-2 px-4 rounded-full text-white">
            <a href="{{ route('front.index') }}">Go To Landing Page</a>
        </div>
    </div>
    <!-- BEGIN: Account Menu -->
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button"
            ...
            {{-- <img alt="User PC Care Image" src="{{ asset('build/assets/images/' . $fakers[9]['photos'][0]) }}"> --}}
            <img alt="User PC Care Image" src="{{ asset('build/assets/images/profile-5.jpg') }}">
        </div>
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                <li class="p-2">
                    ...
                    <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">sebagai Admin</div>
                </li>
                <li>
